...
9. MATEMÁTICA FANTASMA (CRÍTICO): Escaneie o seu texto procurando pelo símbolo de porcentagem (%). Você inventou algum dado como "aumenta em 30%" ou "reduz em 40%" que não estava no briefing? Se sim, APAGUE OS NÚMEROS IMEDIATAMENTE e troque por palavras como "amplia", "reduz", "significativamente".
10. AUDITORIA DE FONTES (RISCO DE FALHA CRÍTICA): Procure pelas palavras "UNESCO", "PISA", "MEC", "OCDE" ou "IBGE" no texto que você acabou de escrever. Elas estão dentro de uma tag <a href="...">? Se você citou o nome mas não colocou o link, VOCÊ DEVE APAGAR O NOME DA INSTITUIÇÃO AGORA MESMO.
