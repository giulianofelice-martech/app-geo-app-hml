...
if 'current_page' not in st.session_state:
    ...
    mapa_reverso = {
        ...
        "monitor": "Monitor de GEO", "revisor": "Revisor & Adaptador", "auditor": "Auditor de Artigos"
    }
...
if page_name == "Gerador de Artigos":
    ...
    path_atual = "/monitor"
elif page_name == "Revisor & Adaptador":
    path_atual = "/revisor"
...
opcoes_menu = ["Gerador de Artigos", "BrandBook", "Monitor de GEO", "Revisor & Adaptador", "Auditor de Artigos"]
...
def buscar_fontes_autoridade(palavra_chave, marca_alvo):
    """
    Busca links usando Zero-Trust, garantindo FRESCOR (último ano) e um 
    volume de 20 opções para equilibrar performance e segurança.
    """
    if not SERPAPI_KEY:
    ...
    # Ampliamos o campo semântico para pegar cartilhas e notícias de vestibular
    query = f"{palavra_chave} (dados OR estatística OR estudo OR edital OR guia OR regras)"
    
    # MUDANÇA APLICADA:
    # num=20 (Testando o meio-termo ideal)
    payload = json.dumps({
        "q": query, 
        "gl": "br", 
        "hl": "pt-br", 
    ...
    try:
        ...
        # 1. PORTA DA FRENTE (Whitelist Expandida)
        imprensa_confiavel = [
            'g1.globo.com', 'uol.com.br', 'estadao.com.br', 'folha.uol.com.br', 
            'cnnbrasil.com.br', 'bbc.com', 'agenciabrasil.ebc.com.br', 'exame.com', 
            'valor.globo.com', 'veja.abril.com.br', 'forbes.com.br', 'terra.com.br',
            'r7.com', 'metropoles.com', 'band.uol.com.br', 'cartacapital.com.br'
        ]
        
        # 2. CONCORRENTES DE MERCADO
        concorrentes = [
        ...
        if "organic" in dados:
            for res in dados["organic"]:
                ...
                # Sucesso! Link fresco (tbs=qdr:y) e seguro.
...
REGRA CRÍTICA E VETO DE CONCORRÊNCIA: É ESTRITAMENTE PROIBIDO extrair ou sugerir links de domínios de sistemas de ensino concorrentes (ex: Poliedro, Anglo, Bernoulli, SAS, Objetivo, Farias Brito, Eleva) ou de sites de outras escolas particulares. 
...
# ==========================================
elif st.session_state['current_page'] == "Revisor & Adaptador":
