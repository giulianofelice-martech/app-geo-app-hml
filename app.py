...
if st.sidebar.button("🚨 TESTAR API WEBFLOW PURA"):
    ...
    st.sidebar.write("Batendo na porta do Webflow...")
    res_teste = requests.get(url_teste, headers=headers_teste)
    
    st.sidebar.write(f"**Código:** {res_teste.status_code}")
    st.sidebar.json(res_teste.json())
# ---------------------------------
